* **Title**: Beacon
* **Description**: This is a template bundle that will map Beacon assessments. 
* **Submitter name**: Theo Kaufman
* **Submitter organization**: Education Analytics

To run this bundle, please add your own source file(s):
<code>data/Beacon.csv</code>
...
- INPUT_FILE: The Beacon assessment results file to be mapped
