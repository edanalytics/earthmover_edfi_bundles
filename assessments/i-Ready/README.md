* **Title**: Curriculum Associates i-Ready - API 3.X
* **Description**: This template maps CA i-Ready files. 
* **API version**: 5.3
...
<details>
<summary><code>data/data - subject.csv</code></summary>
Note: This file is split by subject. The subject is automatically-inferred during the run.
...
"BUNDLE_DIR": ".",
"INPUT_FILE": "path/to/data - subject.csv",
"OUTPUT_DIR": "./output",
...
earthmover run -c ./earthmover.yaml -p '{
"BUNDLE_DIR": ".",
"INPUT_FILE_OVERALL": "path/to/data - subject.csv",
"OUTPUT_DIR": "./output",
